 ...
 * }
*/
function makePersonObject(num, nam, mail) {
  const user = {
    id: num,
    name: nam,
    email: mail,
...
*/
function appleIndex(stuff) {
  return stuff.indexOf('apple');
}
